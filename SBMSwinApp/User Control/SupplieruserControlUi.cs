...
{
    public partial class SupplieruserControlUi : UserControl
    {
        public SupplieruserControlUi()
        {
            InitializeComponent();
        }
        ...
        private void SupplieruserControlUi_Load(object sender, EventArgs e)
        {
        ...
        private void SaveButton_Click_1(object sender, EventArgs e)
        {
            if (IsFormValid())
            {
                if (SaveButton.Text == "Save")
                {
                    ...
                    else if (supplierManager.IsSupplierExist(supplier) == 2)
                    {
                ...
                else if (SaveButton.Text == "Update")
                {
                    ...
                    {
                        var supplier = new Supplier();
                        supplier.Id = Convert.ToInt32(supplierIdLabel.Text);
                        supplier.Code = codeTextBox.Text;
                        supplier.Name = nameTextBox.Text;
                        supplier.Address = addressTextBox.Text;
                        supplier.Email = emailTextBox.Text;
        ...
        private void DisplayDataGridView_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            supplierIdLabel.Text = Convert.ToString(selectedRow.Cells[1].Value);
